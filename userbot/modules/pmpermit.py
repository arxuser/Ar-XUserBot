...
DEF_UNAPPROVED_MSG = (
    ...
    "╾─────────────────────╼\n"
    " Saya adalah pelayan tuan Ar-X\n"
    " Tuan Ar-X Sedang Berdinas\n"
    " Mohon untuk tidak\n"
    " melakukan spam chat\n"
...
async def approvepm(apprvpm):
    ...
    await apprvpm.edit(f"`Terimakasih` [{name0}](tg://user?id={uid}) ` Telah menunggu, Pesan Anda Sudah Diterima Tuan Saya ツ`")
